...
# pip install langchain langchain_community langchain_ollama langchain_core langchain_groq faiss-cpu pdfplumber
...
file_path = 'Universal Declaration Human Rights.pdf'
